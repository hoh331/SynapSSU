...
class CreateClass(CreateClass_Super):        
    def tab_setup(self):
        ...
        """EPSC_PPF Tab Setup"""            
        self.EPSC_PPF_Drain_ParamBox = ui.CreateParameterSettingsBox('Drain bias setup', 1)
        self.EPSC_PPF_Drain_ParamBox.set_item(0, 'Vds', '1', 'V')
        
        self.EPSC_PPF_Gate_ParamBox = ui.CreateParameterSettingsBox('Gate bias setup', 1)
        ...
        self.tab_vbox.addWidget(self.EPSC_PPF_Pulse_ParamBox.groupbox)
